...
👉 So <b>0</b> is the starting point of the linked list or array. It is basically present outside the cycle.<br><br>- So, if we identify the beginning of the cycle, then we know that, that element is the one which should be returned.<br><br>
